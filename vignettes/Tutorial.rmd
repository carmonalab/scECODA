...
# InstallData("pbmc3k")
data("pbmc3k")
seurat_object <- Seurat::UpdateSeuratObject(pbmc3k)
```
...
abundances in %. For details, see review by Greenacre M. ([**see
...
tools available for that purpose, e.g. scCODA or tascCODA ([**see
References**](#references)).
...
by Gong & Sharma *et al.* ([**see References**](#references)):
...
-   Compositional Data Analysis. Greenacre M., Annual Review of Statistics and
    Its Application Volume 8 (2021).
    [**https://doi.org/10.1146/annurev-statistics-042720-124436**](https://doi.org/10.1146/annurev-statistics-042720-124436)
-   scCODA is a Bayesian model for compositional single-cell data analysis.
    Büttner, M., Ostner, J., Müller, C.L. et al. Nat Commun 12, 6876 (2021).
    <https://doi.org/10.1038/s41467-021-27150-6>
    <https://github.com/theislab/scCODA>
-   tascCODA: Bayesian Tree-Aggregated Analysis of Compositional Amplicon and
    Single-Cell Data. Ostner J, Carcy S, Müller CL. Front Genet. (2021) Dec
    7;12:766405. doi: 10.3389/fgene.2021.766405.
    <https://pubmed.ncbi.nlm.nih.gov/34950190/>
    <https://github.com/bio-datascience/tascCODA>
-   Longitudinal Multi-omic Immune Profiling Reveals Age-Related Immune Cell
    Dynamics in Healthy Adults. Gong Q. & Sharma M. et al., bioRxiv [Preprint].
    2024 Sep 14:2024.09.10.612119. [**doi:
    10.1101/2024.09.10.612119**](https://pubmed.ncbi.nlm.nih.gov/39314416/).
