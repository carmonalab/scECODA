...
#' @param celltype_column A character string specifying the name of the
...
seurat_multiply_cells_in_condition <- function(
  ...
  # We subset the original data once to ensure we don't accidentally subset the growing multiplied data
  ...
  new_seurat_object@project.name <- paste0(seurat_object@project.name, "_Targeted_Multiplied")
